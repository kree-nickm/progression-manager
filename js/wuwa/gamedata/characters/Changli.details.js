export default {
    "forte": {
        ...
        "Resonance Skill": {
            ...
            "motionValues": [
                ...
                },
                {
                    ...
                    "name": "True Sight: Capture - Concerto Regen"
                },
                {
                    "scaling": [
                        "7",
                    ...
                    "name": "True Sight: Conquest - Concerto Regen"
                },
                {
                    "scaling": [
                        "6",
        ...
        "Forte Circuit Passive 1": {
            ...
            "desc": "When Changli releases Basic Attack: <color=Highlight>True Sight - Conquest<\/color> or Basic Attack: <color=Highlight>True Sight - Charge<\/color>, for each stack of Enflamement, Changli's Fusion DMG Bonus is increased by 5%."
        },
        ...
        "Intro Skill": {
            ...
            "desc": "Changli appears in mid-air, attacks the target, and enters <color=Highlight>True Sight<\/color>, lasting for 12s."
        },
        "Forte Circuit": {
        ...
        "Outro Skill": {
            ...
            "desc": "The incoming Resonator has their Fusion DMG Amplified by 20% and Resonance Liberation DMG Amplified by 25% for 10s or until the Resonator is switched out."
        },
    ...
    "chain": {
        "1": {
            ...
            "icon": "\/Game\/Aki\/UI\/UIResources\/Common\/Image\/IconDevice\/T_IconDevice_ChangliM1_UI.T_IconDevice_ChangliM1_UI",
            "name": "Hidden Thoughts",
            "desc": "Resonance Skill <color=Highlight>Tripartite Flames<\/color> and Heavy Attack <color=Highlight>Flaming Sacrifice<\/color> increase Changli's DMG dealt by 10% and resistance to interruption."
        },
        "2": {
            "buffs": [
                1205900210
            ],
            "icon": "\/Game\/Aki\/UI\/UIResources\/Common\/Image\/IconDevice\/T_IconDevice_ChangliM2_UI.T_IconDevice_ChangliM2_UI",
        ...
        "3": {
            ...
            "icon": "\/Game\/Aki\/UI\/UIResources\/Common\/Image\/IconDevice\/T_IconDevice_ChangliM3_UI.T_IconDevice_ChangliM3_UI",
            "name": "Learned Secrets",
            "desc": "Resonance Liberation <color=Highlight>Radiance of Fealty<\/color> DMG is increased by 80%."
        },
        "4": {
            "buffs": [
                1205900410
            ],
            "icon": "\/Game\/Aki\/UI\/UIResources\/Common\/Image\/IconDevice\/T_IconDevice_ChangliM4_UI.T_IconDevice_ChangliM4_UI",
            "name": "Polished Words",
        ...
        "5": {
            ...
            "icon": "\/Game\/Aki\/UI\/UIResources\/Common\/Image\/IconDevice\/T_IconDevice_ChangliM5_UI.T_IconDevice_ChangliM5_UI",
            "name": "Sacrificed Gains",
            "desc": "Heavy Attack <color=Highlight>Flaming Sacrifice<\/color>'s Multiplier is increased by 50% and its DMG dealt is increased by 50%."
        },
        "6": {
            "buffs": [
                1205900610
            ],
            "icon": "\/Game\/Aki\/UI\/UIResources\/Common\/Image\/IconDevice\/T_IconDevice_ChangliM6_UI.T_IconDevice_ChangliM6_UI",
            "name": "Realized Plans",
            "desc": "Resonance Skill <color=Highlight>Tripartite Flames<\/color>, Heavy Attack <color=Highlight>Flaming Sacrifice<\/color>, and Resonance Liberation <color=Highlight>Radiance of Fealty<\/color> ignore an additional 40% of the target's DEF when dealing damage."
        }
    }
};