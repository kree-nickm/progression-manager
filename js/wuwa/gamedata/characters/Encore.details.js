export default {
    "forte": {
        ...
        "Forte Circuit": {
            ...
            "desc": "<size=40><color=Title>Heavy Attack: Cloudy Frenzy<\/color><\/size>nWhen Encore's \"Mayhem\" is full, after casting a <color=Highlight>Heavy Attack<\/color>, Encore will consume all \"Mayhem\" to enter the Mayhem state, reducing damage taken by 70%. Switching Characters does not interrupt the Mayhem state.nAfter the Mayhem state ends, Encore will cast <color=Highlight>Cloudy Frenzy<\/color>, dealing <color=Fire>Fusion DMG<\/color>, considered as Resonance Liberation damage.n<size=10> <\/size>n<size=40><color=Title>Heavy Attack: Cosmos Rupture<\/color><\/size>nDuring Cosmos Rave, when casting <color=Highlight>Heavy Attack<\/color>, if \"Mayhem\" is full, Encore will consume all \"Mayhem\" to enter Cosmos' Mayhem state, reducing damage taken by 70%. Switching Characters does not interrupt the Cosmos' Mayhem state.nAfter Cosmos' Mayhem state ends, Encore will cast <color=Highlight>Cosmos Rupture<\/color>, dealing <color=Fire>Fusion DMG<\/color>, considered as Resonance Liberation DMG.<size=10> <\/size>n<size=40><color=Title>Mayhem<\/color><\/size>nEncore can hold up to 100 \"Mayhem\".nWhen Normal Attack <color=Highlight>Wooly Attack<\/color> hits a target, Encore restores \"Mayhem\".nWhen Resonance Skill <color=Highlight>Flaming Woolies<\/color> hits a target, Encore restores \"Mayhem\".nWhen Resonance Skill <color=Highlight>Energetic Welcome<\/color> hits a target, Encore restores \"Mayhem\".nWhen Intro Skill <color=Highlight>Woolies Helpers<\/color> hits a target, Encore restores \"Mayhem\".nDuring the duration of Resonance Liberation <color=Highlight>Cosmos Rave<\/color>, Encore restores \"Mayhem\" when hitting a target."
        },
        "Utility Passive": {
            "icon": "\/Game\/Aki\/Effect\/Texture\/Icon\/IconSkill\/T_IconYangyangQTE_UI.T_IconYangyangQTE_UI",
            "id": 1000708,
    ...
    "chain": {
        ...
        "2": {
            ...
            "desc": "Encore additionally restores 10 Resonance Energy when casting Basic Attack <color=Highlight>Wooly Strike<\/color> or Resonance Skill <color=Highlight>Energetic Welcome<\/color>. This can be triggered once every 10s."
        },
        "3": {
            "buffs": [
                1203903001
