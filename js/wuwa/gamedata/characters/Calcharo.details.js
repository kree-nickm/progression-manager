export default {
    "forte": {
        ...
        "Forte Circuit Passive 1": {
            ...
            "desc": "Casting Heavy Attacy <color=Highlight>Mercy<\/color> gives Calcharo 10% Resonance Liberation DMG Bonus for (1)s."
        },
        ...
        "Forte Circuit": {
            ...
            "desc": "<size=40><color=Title>Heavy Attack: \"Mercy\"<\/color><\/size>nWhen Calcharo has 3 \"Cruelty\", his <color=Highlight>Heavy Attack<\/color> is replaced with Heavy Attack <color=Highlight>\"Mercy.\"<\/color>nWhen casting Heavy Attack <color=Highlight>\"Mercy\"<\/color>, Calcharo consumes 3 \"Cruelty\" to deal <color=Thunder>Electro DMG<\/color>, considered as Heavy Attack DMG, and recovers Resonance Energy and Concerto Energy.n<size=10> <\/size>n<size=40><color=Title>\"Cruelty\"<\/color><\/size>nCalcharo can hold up to 3 \"Cruelty.\"nIn Resonance Liberation <color=Highlight>Deathblade Gear<\/color> state, \"Cruelty\" cannot be acquired.nWhen Resonance Skill <color=Highlight>Extermination Order<\/color> hits the target, gain 1 \"Cruelty.\"n<size=10> <\/size>n<color=Title>Heavy Attack: \"Death Messenger\"<\/color>nWhen Calcharo has 5 \"Killing Intent\", his <color=Highlight>Basic Attack<\/color> is replaced with Heavy Attack <color=Highlight>\"Death Messenger.\"<\/color>nWhen casting Heavy Attack <color=Highlight>\"Death Messenger,\"<\/color> Calcharo consumes 5 \"Killing Intent\" to deal <color=Thunder>Electro DMG<\/color>, considered as Resonance Liberation DMG, and recovers Resonance Energy and Concerto Energy.n<size=10> <\/size>n<size=40><color=Title>\"Killing Intent\"<\/color><\/size>nIn Resonance Liberation <color=Highlight>Deathblade Gear<\/color> state, Calcharo's Forte Gauge is replaced with \"Killing Intent\", stacking up to 5.nWhen Basic Attack <color=Highlight>Hounds Roar<\/color> hits the target, Calcharo gains 1 \"Killing Intent.\""
        },
        "Utility Passive": {
