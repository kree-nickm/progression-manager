export default {
    "forte": {
        "Basic Attack": {
            ...
            "name": "Majestic Fists",
            "desc": "<size=40><color=Title>Basic Attack<\/color><\/size>nLingyang performs up to 5 consecutive attacks, dealing <color=Ice>Glacio DMG<\/color>.n<size=10> <\/size>n<size=40><color=Title>Basic Attack: Feral Roars<\/color><\/size>nAfter Resonance Skill <color=Highlight>Furious Punches<\/color> is cast, <color=Highlight>Basic Attack 5<\/color> is replaced with <color=Highlight>Feral Roars<\/color>, dealing <color=Ice>Glacio DMG<\/color>.n<size=10> <\/size>n<size=40><color=Title>Heavy Attack<\/color><\/size>nLingyang consumes STA to attack the target, dealing <color=Ice>Glacio DMG<\/color>.n<size=10> <\/size>n<size=40><color=Title>Mid-air Attack<\/color><\/size>nLingyang consumes STA to perform a Mid-air Plunging Attack, dealing <color=Ice>Glacio DMG<\/color>.n<size=10> <\/size>n<size=40><color=Title>Dodge Counter<\/color><\/size>nUse <color=Highlight>Basic Attack<\/color> after a successful <color=Highlight>Dodge<\/color> to attack the target, dealing <color=Ice>Glacio DMG<\/color>."
        },
        "Resonance Skill": {
            ...
            "name": "Ancient Arts",
            "desc": "<size=40><color=Title>Ancient Arts<\/color><\/size>nAttack the target, dealing <color=Ice>Glacio DMG<\/color>.n<size=10> <\/size>n<size=40><color=Title>Furious Punches<\/color><\/size>nWhen <color=Highlight>Basic Attacks 3, 4, or 5<\/color> or Basic Attack <color=Highlight>Feral Roars<\/color> hits the target, Resonance Skill <color=Highlight>Ancient Arts<\/color> is replaced with Resonance Skill <color=Highlight>Furious Punches<\/color>.nLingyang's <color=Highlight>Basic Attack<\/color> cycle starts from <color=Highlight>Basic Attack 3<\/color> after casting Basic Attack <color=Highlight>Feral Roars<\/color> and Resonance Skill <color=Highlight>Furious Punches<\/color> in turn.n<size=10> <\/size>nLingyang's Resonance Skill does not reset his Basic Attack cycle."
        },
        ...
        "Forte Circuit Passive 1": {
            ...
            "id": 1001804,
            "name": "Lion's Pride",
            "desc": "DMG of the Intro Skill <color=Highlight>Lion Awakens<\/color> is increased by 50%."
        },
        ...
        "Forte Circuit": {
            ...
            "desc": "<size=40><color=Title>Heavy Attack: Glorious Plunge<\/color><\/size>nWhen \"Lion's Spirit\" is full, use <color=Highlight>Heavy Attack<\/color> to perform <color=Highlight>Glorious Plunge<\/color>, dealing <color=Ice>Glacio DMG<\/color>.n<size=10> <\/size>n<size=40><color=Title>Mid-air Attack: Tail Strike<\/color><\/size>nWhen \"Lion's Spirit\" is not full, use <color=Highlight>Basic Attack<\/color> after <color=Highlight>Heavy Attack<\/color> to perform <color=Highlight>Tail Strike<\/color>, dealing <color=Ice>Glacio DMG<\/color>.n<size=10> <\/size>n<size=40><color=Title>Striding Lion<\/color><\/size>nAfter casting Heavy Attack <color=Highlight>Glorious Plunge<\/color>, enter <color=Highlight>Striding Lion<\/color> state;nAfter casting Intro Skill <color=Highlight>Lion Awakens<\/color> or Resonance Liberation <color=Highlight>Strive: Lion's Vigor<\/color>, if \"Lion's Spirit\" is full, use <color=Highlight>Basic Attack<\/color> to enter <color=Highlight>Striding Lion<\/color> state.nIn the <color=Highlight>Striding Lion<\/color> state:n-Attacks can be launched in mid-air. If Lingyang is on the ground, use Heavy Attack <color=Highlight>Glorious Plunge<\/color> to get back in the air.n-\"Lion's Spirit\" is continuously consumed before running out in 5s, and when it runs out, <color=Highlight>Striding Lion<\/color> ends;n-If Lingyang is in the Resonance Liberation <color=Highlight>Lion's Vigor<\/color> state, the consumption speed of \"Lion's Spirit\" is reduced by 50%, extending <color=Highlight>Striding Lion<\/color> state by up to 10s.n-Lingyang's <color=Highlight>Basic Attack<\/color> is replaced with Basic Attack <color=Highlight>Feral Gyrate<\/color>, which performs up to 2 consecutive attacks, dealing <color=Ice>Glacio DMG<\/color>;n-Lingyang's <color=Highlight>Resonance Skill<\/color> is replaced with <color=Highlight>Mountain Roamer<\/color>, dealing <color=Ice>Glacio DMG<\/color>;n-When \"Lion's Spirit\" is less than 10, use <color=Highlight>Basic Attack<\/color> to perform <color=Highlight>Stormy Kicks<\/color>, dealing <color=Ice>Glacio DMG<\/color>; after performing Basic Attack <color=Highlight>Stormy Kicks<\/color>, the Mid-air Attack <color=Highlight>Tail Strike<\/color> becomes available.n-Concerto Energy is restored when \"Lion's Spirit\" is consumed.n<size=10> <\/size>n<size=40><color=Title>Lion's Spirit<\/color><\/size>nLingyang can hold up to 100 \"Lion's Spirit\".nWhen casting Resonance Skill <color=Highlight>Furious Punches<\/color>, \"Lion's Spirit\" is restored.nWhen casting Intro Skill <color=Highlight>Lion Awakens<\/color>, \"Lion's Spirit\" is restored.nWhen casting Resonance Liberation <color=Highlight>Strive: Lion's Vigor<\/color>, \"Lion's Spirit\" is restored."
        },
        "Utility Passive": {
