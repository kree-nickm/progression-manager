...
const {default:FurnitureSet} = await window.importer.get(`js/genshin/FurnitureSet.js`);
...
export default class FurnitureSetList extends GenshinList
{
  ...
  setupDisplay()
  {
    ...
    FurnitureSet.setupDisplay(this.display);
  }
  ...
  prepareRender(element, data, options)
  {
    data.fields = [
      ...
      {field:this.display.getField("recipe"), params:[]},
      {field:this.display.getField("characters"), params:[]},
    ];
